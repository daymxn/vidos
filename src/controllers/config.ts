import { IOError, encodeClassToJSON, fileExists, tryOrThrow } from "@src/util";
...
// TODO: do out with this after implementing `init`, and throw if not found
const DEFAULT_CONFIG = new Config([], "./config.json", {
...
export { Config, Domain, DomainStatus, createConfig, loadConfig };
